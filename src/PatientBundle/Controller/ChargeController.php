...
use PatientBundle\Entity\Charge;
...
class ChargeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $charges = $em->getRepository('PatientBundle:Charge')->findAll();
    ...
    {
        $charge = new Charge();
        $form = $this->createForm('PatientBundle\Form\ChargeType', $charge);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('charge_index', array('id' => $charge->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($charge);
        $editForm = $this->createForm('PatientBundle\Form\ChargeType', $charge);
